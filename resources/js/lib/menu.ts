...
export const NAV: NavItem[] = [
    ...
    /* 10 ── الخزينة ─────────────────────────────────────────── */
    {
        ...
        children: [
            ...
            { to: '/treasury/operations', permission: 'treasury.manage', label: tr('عمليات الخزينة'), icon: ArrowLeftRight },
            { to: '/treasury/recurring-expenses', permission: 'treasury.manage', label: tr('المصروفات الدورية'), icon: Repeat },
...
const SCREEN_PERMISSION_BY_PATH: Record<string, string> = {
    ...
    '/treasury/recurring-expenses': 'screen.treasury.operations',
