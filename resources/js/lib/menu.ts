...
export const NAV: NavItem[] = [
    ...
    /* 14 ── المحاسبة المالية ───────────────────────────────── */
    {
        ...
        children: [
            ...
            { to: '/accounting/ledger', permission: 'accounting.view', label: 'الأستاذ العام', icon: BookOpen },
            { to: '/accounting/trial-balance', permission: 'accounting.view', label: 'ميزان المراجعة', icon: Scale },
            { to: '/accounting/income-statement', permission: 'accounting.view', label: 'قائمة الدخل', icon: BarChart3 },
            { to: '/accounting/balance-sheet', permission: 'accounting.view', label: 'الميزانية العمومية', icon: PieChart },
            { to: '/accounting/cost-centers', permission: 'accounting.view', label: 'مراكز التكلفة', icon: Target },
        ],
    },
    ...
    /* 17 ── التقارير ────────────────────────────────────────── */
    {
        ...
        children: [
            ...
            { to: '/reports/profit', permission: 'reports.view', label: 'تقارير الأرباح', icon: Scale },
            { to: '/reports/stock', permission: 'reports.view', label: 'تقارير المخزون', icon: BoxesIcon },
            { to: '/reports/custody', permission: 'reports.view', label: 'تقارير العهد', icon: HandCoins },
            { to: '/reports/contracts', permission: 'reports.view', label: 'تقارير العقود', icon: ScrollText },
            { to: '/reports/warranties', permission: 'reports.view', label: 'تقارير الضمانات', icon: ShieldCheck },
            { to: '/reports/crm', permission: 'reports.view', label: 'تقارير العملاء المحتملين', icon: Contact },
            { to: '/reports/hr', permission: 'reports.view', label: 'تقارير الموارد البشرية', icon: UserCog },
            { to: '/reports/maintenance', permission: 'reports.view', label: 'تقارير الصيانة و PPM', icon: Wrench },
            { to: '/reports/custom', permission: 'reports.view', label: 'التقارير المخصصة', icon: BadgePercent },
        ],
    },
