...
const STATUS: Record<AttendanceStatus, { label: string; chip: string }> = {
    present: { label: tr('حاضر'), chip: 'bg-emerald-50 text-emerald-700 ring-1 ring-emerald-200' },
    late: { label: tr('متأخر'), chip: 'bg-amber-50 text-amber-700 ring-1 ring-amber-200' },
    absent: { label: tr('غائب'), chip: 'bg-red-50 text-red-700 ring-1 ring-red-200' },
    leave: { label: tr('إجازة'), chip: 'bg-sky-50 text-sky-700 ring-1 ring-sky-200' },
    holiday: { label: tr('عطلة'), chip: 'bg-slate-100 text-slate-500 ring-1 ring-slate-200' },
}
