        ...
        <form onSubmit={handleSubmit}>
            ...
            <section className="card mb-5 p-5">
                ...
                <p className="mb-3 text-[11px] leading-relaxed text-navy-400">
                    {tr('الاختيار محفوظ على هذا الجهاز وحده — نفس الحساب يُفتح على شاشة مكتب وعلى موبايل في موقع ليلًا، وليست نفس الإجابة.')}
                </p>
                <ThemePicker />

                <h2 className="mt-5 mb-1 text-sm font-bold text-navy-800">اللغة</h2>
                <p className="mb-3 text-[11px] leading-relaxed text-navy-400">
                    {tr('الإنجليزية مطبَّقة على الإطار — القوائم والأزرار ورؤوس الجداول والحالات — وباقي الشاشات تظهر بالعربية حتى تُترجَم. المستندات المطبوعة تبقى بالعربية.')}
                </p>
                <LanguagePicker />
            </section>
