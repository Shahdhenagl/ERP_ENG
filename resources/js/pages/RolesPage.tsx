    ...
    return (
        <>
            ...
            <p className="mb-4 rounded-xl bg-navy-50 px-3 py-2.5 text-xs leading-relaxed text-navy-500">
                {tr('تعديل صلاحيات الدور ينتقل فورًا إلى كل من يحمله. ولمنح مستخدم بعينه استثناءً — صلاحية زائدة أو منزوعة — افتح ملفه من شاشة المستخدمين؛ الاستثناء يبقى معه.')}
            </p>
            ...
            <div className="space-y-4">
                ...
                {isAdmin ? (
                    <p className="rounded-xl bg-amber-50 px-3 py-2.5 text-xs leading-relaxed text-amber-800">
                        {tr('مدير النظام يملك كل الصلاحيات ولا يمكن تقييده. لدور محدود الصلاحيات اختر «موظف مكتب».')}
                    </p>
                ) : (
                    <>
                        {errors.permissions && (
