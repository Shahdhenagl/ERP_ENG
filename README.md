...
هذه المرحلة تغطي **دورة التركيب والصيانة** فقط. الموديولات التالية مؤجّلة عمدًا
(راجع [docs/requirements-analysis.md](docs/requirements-analysis.md)):

المخزون والمشتريات · العقود والضمان · الحسابات والخزنة · إدارة العُهد ·
