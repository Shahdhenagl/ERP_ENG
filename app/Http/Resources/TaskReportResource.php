    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'readings' => [
                ...
                'input_voltage_l2' => $this->input_voltage_l2,
                'input_voltage_l3' => $this->input_voltage_l3,
                'output_voltage' => $this->output_voltage,
                'output_voltage_l2' => $this->output_voltage_l2,
                'output_voltage_l3' => $this->output_voltage_l3,
